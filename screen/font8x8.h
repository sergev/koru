...
//
// Generated by screen/tools/mkfont.py. Do not edit: edit the glyph art
// there and re-run it. The font is authored for this repository.
//
// One glyph is eight rows of eight bits, low bit leftmost. The art is 5x7
// inside that, which leaves the spacing a terminal cell needs.
#pragma once
...
#define KS_FONT_W 8
#define KS_FONT_H 8
#define KS_FONT_FIRST 0x20
#define KS_FONT_LAST 0x7e

// ASCII 0x20 through 0x7e, in order.
static const uint8_t KS_FONT[KS_FONT_LAST - KS_FONT_FIRST + 1][KS_FONT_H] = {
    ...
    { 0x06, 0x09, 0x09, 0x06, 0x19, 0x09, 0x16, 0x00 }, // &
    ...
    { 0x0e, 0x11, 0x01, 0x19, 0x11, 0x11, 0x0e, 0x00 }, // G
...
// What a codepoint outside the font draws: U+FFFD's box.
static const uint8_t KS_FONT_MISSING[KS_FONT_H] = { 0x1f, 0x15, 0x1b, 0x15, 0x1f, 0x00, 0x00, 0x00 };

...
use koru_sys::abi::{
    ...
    KORU_NR_ENTER, KORU_NR_GET_PARAMS, KORU_NR_SETUP, KORU_O_ACCMODE, KORU_O_APPEND, KORU_O_CREAT,
    KORU_O_DIRECTORY, KORU_O_EXCL, KORU_O_NOFOLLOW, KORU_O_NONBLOCK, KORU_O_RDONLY, KORU_O_RDWR,
    KORU_O_TRUNC, KORU_O_WRONLY, KORU_OP_ADOPT_FD, KORU_OP_CANCEL, KORU_OP_CHECKSUM, KORU_OP_CLOSE,
    KORU_OP_DELAY_NS, KORU_OP_MKDIR, KORU_OP_NOP, KORU_OP_OPEN, KORU_OP_POLL_ADD, KORU_OP_READ,
    KORU_OP_READDIR, KORU_OP_READLINK, KORU_OP_RENAME, KORU_OP_RMDIR, KORU_OP_STAT,
    KORU_OP_STATX_AT, KORU_OP_SYMLINK, KORU_OP_TRUNCATE, KORU_OP_UNLINK, KORU_OP_UTIMES,
    KORU_OP_WRITE, KORU_OPEN_FLAGS_ALL, KORU_OPEN_MODE_ALL, KORU_POLL_ERR, KORU_POLL_EVENTS_ALL,
...
fn main() {
    ...
    konst(&mut out, &mut c, "KORU_O_CREAT", "u32", KORU_O_CREAT as u64);
    konst(&mut out, &mut c, "KORU_O_EXCL", "u32", KORU_O_EXCL as u64);
    konst(&mut out, &mut c, "KORU_O_TRUNC", "u32", KORU_O_TRUNC as u64);
    konst(
        &mut out,
        &mut c,
        "KORU_O_APPEND",
        "u32",
        KORU_O_APPEND as u64,
    );
    konst(
        &mut out,
        &mut c,

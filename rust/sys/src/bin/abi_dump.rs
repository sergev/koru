...
use koru_sys::abi::{
    ...
    KORU_OP_OPEN, KORU_OP_POLL_ADD, KORU_OP_READ, KORU_OP_READLINK, KORU_OP_RMDIR, KORU_OP_STAT,
    KORU_OP_STATX_AT, KORU_OP_SYMLINK, KORU_OP_TRUNCATE, KORU_OP_UNLINK, KORU_OP_UTIMES,
    KORU_OP_WRITE, KORU_OPEN_FLAGS_ALL, KORU_POLL_ERR, KORU_POLL_EVENTS_ALL, KORU_POLL_HUP,
    KORU_POLL_IN, KORU_POLL_OUT, KORU_POLL_PRI, KORU_POLL_RDHUP, KORU_S_IFBLK, KORU_S_IFCHR,
    KORU_S_IFDIR, KORU_S_IFIFO, KORU_S_IFLNK, KORU_S_IFMT, KORU_S_IFREG, KORU_S_IFSOCK,
    KORU_SETUP_FLAGS_ALL, KORU_SQE_FLAGS_ALL, KORU_STAT_ALL, KORU_STAT_ATIME, KORU_STAT_BLKSIZE,
    KORU_STAT_BLOCKS, KORU_STAT_BTIME, KORU_STAT_CTIME, KORU_STAT_DEV, KORU_STAT_GID,
    KORU_STAT_INO, KORU_STAT_MODE, KORU_STAT_MTIME, KORU_STAT_NLINK, KORU_STAT_RDEV,

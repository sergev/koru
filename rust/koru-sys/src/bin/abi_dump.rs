...
use koru_sys::abi::{
    ...
    KORU_O_RDONLY, KORU_O_RDWR, KORU_O_WRONLY, KORU_OP_CANCEL, KORU_OP_CHECKSUM, KORU_OP_CLOSE,
    KORU_OP_DELAY_NS, KORU_OP_NOP, KORU_OP_OPEN, KORU_OP_READ, KORU_OP_WRITE, KORU_OPEN_FLAGS_ALL,
